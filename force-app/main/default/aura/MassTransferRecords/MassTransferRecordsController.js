({
        ...
        if(component.get("v.id") != null){
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {
                    ...
                    //component.set("v.recruiterW_WO", "WithoutRecruiter");
                    //console.log('recruiter without ' + component.get("v.recruiterW_WO"));
    ...
    Search : function(component, event, helper ){
        ...
        /**if(component.find("recruiterW_WOId").get("v.value") != null){
            component.set("v.recruiterW_WO", component.find("recruiterW_WOId").get("v.value"));
            console.log('recruiter without ' + component.get("v.recruiterW_WO"));
        }**/
        helper.SearchHelper(component,event,helper);
    },
