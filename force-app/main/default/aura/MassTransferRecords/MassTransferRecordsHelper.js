({
    SearchHelper: function(component, event, helper) {
        component.set('v.contactrows', [
            ...
            {label: 'Provider Created Date', fieldName: 'CreatedDate', type:'text', sortable: true}
        ]);
