       ...
       var forclose = component.find("searchRes3");
        ...
        var lookUpTarget = component.find("lookupField1");
            ...
            $A.util.removeClass(lookUpTarget, 'slds-show');
                  ...
                  if(storeResponse[0].Start_Date__c != null){
                component.set("v.DaysValues.Start_Date__c",  storeResponse[0].Start_Date__c);

                  }
                 if(storeResponse[0].End_Date__c != null){
                component.set("v.DaysValues.End_Date__c",  storeResponse[0].End_Date__c);

                  }
                if(storeResponse[0].Monday_Timings_For_Testing__c != null){
                
                       
                    component.set("v.monday", true);
                    component.set("v.startendtime", false);
                    component.set("v.DaysValues.Monday_Timings_For_Testing__c",  storeResponse[0].Monday_Timings_For_Testing__c);
                }
                if(storeResponse[0].Tuesday_Timings__c != null){
                  
                    component.set("v.tuesday", true);
                    component.set("v.startendtime", false);
                    component.set("v.DaysValues.Tuesday_Timings__c", storeResponse[0].Tuesday_Timings__c);
                }
                 if(storeResponse[0].Wednesday_Timings__c != null){
   
                    component.set("v.wednesday", true);
                    component.set("v.startendtime", false);
                    component.set("v.DaysValues.Wednesday_Timings__c", storeResponse[0].Wednesday_Timings__c);
                }
                 if(storeResponse[0].Thursday_Timings__c != null){
                   
                    
                    component.set("v.thursday", true);
                    component.set("v.startendtime", false);
                    component.set("v.DaysValues.Thursday_Timings__c", storeResponse[0].Thursday_Timings__c);
                }
                if(storeResponse[0].Friday_Timings__c != null){
                               component.set("v.friday", true);
                    component.set("v.startendtime", false);
                    component.set("v.DaysValues.Thursday_Timings__c", storeResponse[0].Friday_Timings__c);
                }
                if(storeResponse[0].Saturday_Timings__c != null){
                     
                    
                    component.set("v.saturday", true);
                    component.set("v.startendtime", false);
                    component.set("v.DaysValues.Saturday_Timings__c", storeResponse[0].Saturday_Timings__c);
                }
                 if(storeResponse[0].Sunday_timings__c != null){
                    component.set("v.sunday", true);
                    component.set("v.startendtime", false);
                    component.set("v.DaysValues.Sunday_timings__c", storeResponse[0].Sunday_timings__c);
                }
                if(storeResponse[0].Class_Timings__c != null){
                    component.set("v.startendtime", true);
                  
                    component.set("v.DaysValues.Class_Timings__c", storeResponse[0].Class_Timings__c);
                }
                 if(storeResponse[0].Same_time_for_all_days__c == null){
                    component.set("v.startendtime", true);
       ...
       component.set("v.checkboxss", status) ;       
        ...
        if(status ==  true){
            component.set("v.startendtime", true);
             ...
             component.set("v.DaysValues.Class_Timings__c", null);
             component.set("v.startendtime", false);
...
timeString = h + timeString.substr(2, 3) + whiteSpace+ ampm; 
 ...
 //alert("ss"+JSON.stringify("Ss"+picklistvalues));
  ...
  // This function call when the end User Select any record from the result list.   
    handleComponentEvent3 : function(component, event, helper) {
                        component.set("v.basedonfirstnameopenpopup", false);
    ...
    // get the selected Account record from the COMPONETN event 	 
      ...
      opensearchpopup: function(component, event, helper) {
        component.set("v.basedonfirstnameopenpopup", true);
         var getInputkeyWord =  component.get("v.SearchKeyWord3");
          //alert("ss"+getInputkeyWord);
     var action = component.get("c.fetchclasscoursepopup");
      // set param to method  
        action.setParams({
            'searchKeyWord': component.get("v.SearchKeyWord3")
    ...
    closeModel7 : function(component, event, helper) {
                component.set("v.basedonfirstnameopenpopup", false);
